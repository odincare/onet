...
// protocol data unit
// PDU是 DUL Messages的接口， 如 A-ASSOCIATE-AC, P-DATA-TF
type PDU interface {
	fmt.Stringer

	// WritePayload 负责编码PDU payload， 这里的payload将前6比特的通用PDU type 除外，
	// 他们会被单独编码为EncodePDU
...
// SubItem DUL items的接口，如ApplicationContextItem和TransferSyntaxSubItem
...
// A-ACCEPT中三次握手时 abstractSyntax/transferSyntax的结果， P3.8
// 90.3.3.2, table 9-18
